...
下载并使用 Scripting 打开：[Codex Usage.scripting](https://raw.githubusercontent.com/StarYunLee/Profiles/main/Scripting/Codex%20Usage.scripting)

### 从源码导入

1. 下载本项目源码目录或发布的 `.scripting` 安装包。
...
- 问题反馈：[GitHub Issues](https://github.com/StarYunLee/Profiles/issues)
