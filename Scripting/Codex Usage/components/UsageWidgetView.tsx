...
function watermarkFile(provider: ProviderBrand): string {
  const name = provider === "claude" ? "watermark-claude.png" : provider === "grok" ? "watermark-grok.png" : "watermark-chatgpt.png"
  return `${Script.directory}/assets/${name}`
}
