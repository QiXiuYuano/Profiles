...
------------------------------------------
@Author: GeNie0x00
@Date: 2025-09-27 14:35:00
@Description:DeepFlood签到脚本，根据@Sliverkiss原NodeSeek签到脚本微调
-----------------------------------------
...
const $ = new Env("DeepFlood");
const ckName = "deepflood_data";
...
$.is_default = (function () {
    try {
        if (typeof $argument !== 'undefined' && $argument) {
            ...
            if (params['deepflood_default'] !== undefined && params['deepflood_default'] !== '') return String(params['deepflood_default']);
        }
    } catch (e) {}
    return ($.isNode() ? process.env['deepflood_default'] : $.getdata('deepflood_default')) || 'false';
})();
//------------------------------------------
async function main() {
...
class UserInfo {
    constructor(user) {
        ...
        this.ckStatus = true;
        this.baseUrl = `https://www.deepflood.com`;
        this.headers = {
